...
const PersonModal = ({ personmodalVisible, setPersonModalVisible, onDone }) => {
    ...
    const togglePerson = (person) => {
        if (person.Name === 'Other') {
            ...
            const isSelected = selectedPersons.some(per => per.Id === person.Id);
            console.log(isSelected)
            if (isSelected) {
                setSelectedPersons(selectedPersons.filter((per) => per.Id !== person.Id));
                ...
                <View style={styles.modalView}>
                    ...
                    {persons.map((person, index) => (
                            <View key={index} style={styles.checkboxContainer}>
                                <CheckBox
                                    value={selectedPersons.some(per => per.Id === person.Id) || (person.Name === 'Other' && isOtherSelected)}
                                    onValueChange={() => togglePerson(person)}
